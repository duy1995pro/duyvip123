...
module.exports.run = function({ api, event, args }) {
    ...
    const moduleName = this.config.name;
		return api.sendMessage(msg + `[ Sử dụng: "${(threadSetting.hasOwnProperty("PREFIX")) ? threadSetting.PREFIX : global.config.PREFIX}menu từng lệnh ở trên" để xem chi tiết cách sử dụng! | Hiện tại đang có 519 lệnh có thể sử dụng trên bot này ]\n🔥Bot Được Support By: NĐD Sau 120s >menu sẽ tự động xóa🔥`, threadID,
